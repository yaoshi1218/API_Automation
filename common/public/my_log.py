...
from Python接口项目实战.InterfaceTest.common.public.project_path import *  #引用test_log路径
...
class MyLog:
    ...
    def my_log(self,level,msg):
        ...
        fh=logging.FileHandler(test_log_path+'\\'+self.log_file_name,encoding='utf-8')#设置输出到文本
