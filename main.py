...
from Python接口项目实战.InterfaceTest.common.public.project_path import *
from Python接口项目实战.InterfaceTest.common.public.my_config import ReadConfig
from Python接口项目实战.InterfaceTest.test_case.test_login import Test_Login
from Python接口项目实战.InterfaceTest.test_case.test_recharge import Test_Recharge
from Python接口项目实战.InterfaceTest.test_case.test_register import Test_Register
from Python接口项目实战.InterfaceTest.test_case.test_withdraw import Test_Withdraw
from Python接口项目实战.InterfaceTest.test_case.test_add_loan import Test_Add_Loan
from Python接口项目实战.InterfaceTest.test_case.test_invest import Test_Invest
import unittest
